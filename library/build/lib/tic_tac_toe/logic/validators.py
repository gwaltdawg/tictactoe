...
def validate_grid(grid: Grid) -> None:
	## exmpl of regex: \s=space, {9}=9-fold repetition, [ab]=any of a or b ##
	## (r produces a raw string, which I still don't really understand...) ##
	if not re.match(r"[\sOX]{9}", grid.cells):
